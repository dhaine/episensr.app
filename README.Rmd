...
[![Travis build status](https://travis-ci.org/dhaine/episensr.app.svg?branch=master)](https://travis-ci.org/dhaine/episensr.app)
<!-- badges: end -->
...
You can install the development version from [GitHub](https://github.com/dhaine/episensr.app) with:
